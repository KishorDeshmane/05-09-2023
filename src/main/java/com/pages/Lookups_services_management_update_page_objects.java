...
public class Lookups_services_management_update_page_objects {
	...
	public boolean page_header_text_should_be_displayed() {
		return update_service_page_header_text.isDisplayed();
	}
	...
	public boolean breadcrumb_services_button_should_be_clickable() {
		return services_breadcrumb_button.isEnabled();
	}

	public boolean breadcrumb_active_page_text_should_be_displayed() {
		return update_services_active_page_in_breadcrumb.isDisplayed();
	}
